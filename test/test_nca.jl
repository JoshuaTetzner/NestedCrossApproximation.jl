...
estimate_reldifference(hmat_topdown_iaca_mimicry, A; tol=tol * 1e-1)
...
#NestedCrossApproximation.storage(hmat_bottomup_mimicry)
...
estimate_reldifference(hmat_bottomup_treemimicry, A; tol=tol * 1e-1)
y_bottomup_treemimicry = hmat_bottomup_treemimicry * x;
println(norm(A * x - y_bottomup_treemimicry) / norm(A * x))
#NestedCrossApproximation.storage(hmat_bottomup_treemimicry)
